...
function ubb($Text) {
  ...
  $Text = preg_replace_callback("/\[colorTxt\](.+?)\[\/colorTxt\]/is", function($r) {
  	return color_txt($r[1]);
  } ,$Text);
  //$Text=preg_replace("/\[emot\](.+?)\[\/emot\]/eis","emot('\\1')",$Text);
  $Text = preg_replace_callback("/\[emot\](.+?)\[\/emot\]/is", function($r) {
  	return emot($r[1]);
  } ,$Text);
  ...
  $Text = preg_replace_callback("/\[code\](.+?)\[\/code\]/is", function($r) {
  	return highlight_code($r[1]);
  } ,$Text);
  //$Text=preg_replace("/\[php\](.+?)\[\/php\]/eis","highlight_code('\\1')", $Text);
  $Text = preg_replace_callback("/\[php\](.+?)\[\/php\]/is", function($r) {
  	return highlight_code($r[1]);
  } ,$Text);
